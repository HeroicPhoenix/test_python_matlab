mysum_pkg MATLAB Python Package
...
2. Installing the mysum_pkg Package

A. Change to the directory that contains the file setup.py and the subdirectory 
mysum_pkg. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the mysum_pkg Package

The mysum_pkg package is on your Python path. To import it into a Python script or 
session, execute:
